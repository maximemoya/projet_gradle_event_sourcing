...
object StarWarsFilmsDataBase : Table("STAR_WARS_FILMS")
...
//        )
//    }
    Database.connect("jdbc:postgresql://localhost:5432/postgres", driver = "org.postgresql.Driver", user = "test", password = "test")
